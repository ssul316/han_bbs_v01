...
<title>Insert title here</title>
      ...
      <style>
         .bbs {width: 1000px; border:1 solid red;border-top:none;border-right:none}
         .bbs ul {clear: left;margin: 0;padding: 0;list-style-type: none;border-top:1 solid red;} 
         /* list-style-type 블릿표시 padding: 0; 들여쓰기*/
         .bbs .subject {font-weight: bold;text-align: center;}
         .bbs ul li {text-align: center;float: left;margin: 0;padding: 2px, 1px;border-right:1 solid red;width: 160px;}
         .bbs ul .col {width: 99px;} /* 표 라인 맞추기기 위해*/
      </style>
